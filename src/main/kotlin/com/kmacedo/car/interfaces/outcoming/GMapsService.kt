package com.kmacedo.car.interfaces.outcoming
...
//Classe que realiza a busca do tempo de distancia automaticamente.

@Service
class GMapsService (@Value("\${app.car.domain.googlemaps.apikey}") val appKey: String){

    val GMAPS_TEMPLATE: String = "https://maps.googleapis.com/maps/api/directions/json?origin={origin}&destination=" +
            "{destination}&key={key}"
    fun getDistanceBetweenAddressses(addressOne: String, addressTwo: String) : Int {
